  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
      ...
      <div className="space-y-5">
        ...
        {/* Generate Button */}
        <button className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg transition-all shadow-lg">
          Generate Signage
        </button>
      </div>
    </div>
